...
$$
E\left[\exp \left( iu \sum_{i=1}^{M_N} \left\{ V_{N,i}  - E[V_{N,i} \mid \mathcal{F}^N] \right\}  \right) \bigg\rvert \mathcal{F}^N \right] \overset{\text{p}}{\to} \exp\left(-u^2\sigma^2/2 \right)
$$
...
$$
E\left[\exp \left( iu M_N^{-1/2}\sum_{i=1}^{M_N} \left\{ f(\xi^{N,i})  - E[f(\xi^{N,i}) \mid \mathcal{F}^N] \right\}  \right) \bigg\rvert \mathcal{F}^N \right] \overset{\text{p}}{\to} \exp\left(-u^2\sigma^2/2 \right)
$$
for any real $u$ if three conditions hold...

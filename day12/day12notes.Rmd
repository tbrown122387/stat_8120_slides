...
In the upcoming theorem, the right hand side's components are what we make assumptions about, and the left hand side is what we want to show converges to $0$.


Proof details can be found in attached pdf.

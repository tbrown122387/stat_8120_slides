...
$$
M_N^{1/2}  E\left[ f(\xi^{N,1}_k) \mid \tilde{\mathcal{F}}^N_{k-1} \right] = M_N^{1/2}\tilde{M}_N^{1/2} \sum_{j=1}^{\tilde{M}_N} \frac{\tilde{\omega}_k^{N,j}}{\sum_{j'} \tilde{\omega}_k^{N,j'}}f(\tilde{\xi}^{N,j}_k)
$$

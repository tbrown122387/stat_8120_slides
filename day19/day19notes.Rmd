...
&=  \frac{ M_N^{-1}\sum_{i=1}^{M_N} \omega^{N,i} \frac{d\mu}{d\nu}(\xi^{N,i}) \left| f(\xi^{N,i}) \right| \mathbb{1}\left( \left| f(\xi^{N,i}) \right| \ge C\right)  }{ M_N^{-1}\sum_{j=1}^{M_N} \omega^{N,j} \frac{d\mu}{d\nu}(\xi^{N,j}) }   
\end{align*}
...
&=
\frac{1}{\tilde{M}_N} \sum_{i=1}^{\tilde{M}_N} \left\{ f(\tilde{\xi}^{N,i}) - E[ f(\tilde{\xi}^{N,i}) \mid \mathcal{F}^N] \right\} +
\frac{1}{\tilde{M}_N} \sum_{i=1}^{M_N} f(\xi^{N,i}) E[N^i \mid \mathcal{F}^N] - \mu(f) \\
&\overset{\text{p}}{\to} 0.
\end{align*}